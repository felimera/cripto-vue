...
const { monedas, criptoMonedas, cargando, cotizacion, obtenerCotizacion, isMostrarResultado } = useCripto();
...
<template>
  <div class="contenedor">
    ...
    <div class="contenido">
      ...
      <div class="contenedor-resultado" v-if="isMostrarResultado">
        <h2>Cotización</h2>
        <div class="resultado">
          ...
          <div>
            ...
            <p>Variación las últimas 24 horas : <span>{{ cotizacion.CHANGEPCT24HOUR }}%</span></p>
